...
var Scheduler = /** @class */ (function() {
  ...
  Scheduler.prototype.scheduleFunction = function(
      cb, delay, args, isPeriodic, isRequestAnimationFrame, id) {
    if (args === void 0) {
      args = [];
    }
  ...
  Scheduler.prototype.tick = function(millis, doTick) {
    ...
    while (this._schedulerQueue.length > 0) {
      ...
      if (finalTime < current.endTime) {
        ...
        var retval = current_1.func.apply(
            global, current_1.isRequestAnimationFrame ? [this._currentTime] : current_1.args);
        if (!retval) {
...
var FakeAsyncTestZoneSpec = /** @class */ (function() {
    ...
    switch (task.type) {
      case 'microTask':
        ...
        this._microtasks.push(
            {func: task.invoke, args: additionalArgs, target: task.data && task.data.target});
        break;
      case 'macroTask':
        switch (task.source) {
          case 'setTimeout':
            task.data['handleId'] = this._setTimeout(
                task.invoke, task.data['delay'], Array.prototype.slice.call(task.data['args'], 2));
            break;
          case 'setImmediate':
            task.data['handleId'] =
                this._setTimeout(task.invoke, 0, Array.prototype.slice.call(task.data['args'], 1));
            break;
          case 'setInterval':
          ...
          case 'XMLHttpRequest.send':
            throw new Error(
                'Cannot make XHRs from within a fake async test. Request URL: ' + task.data['url']);
          ...
          case 'mozRequestAnimationFrame':
            ...
            task.data['handleId'] = this._setTimeout(
                task.invoke, 16, task.data['args'], this.trackPendingRequestAnimationFrame);
            break;
          default:
            ...
            if (macroTaskOption) {
              ...
              var callbackArgs =
                  macroTaskOption.callbackArgs ? macroTaskOption.callbackArgs : args_1;
  ...
  FakeAsyncTestZoneSpec.prototype.onInvoke = function(
  ...
  FakeAsyncTestZoneSpec.prototype.onHandleError = function(
...
//# sourceMappingURL=fake-async-test.umd.js.map
